...
<p style="text-align: justify;font-family: none;">image: "/images/load_unv_data.PNG"</p>
...
<p style="text-align: justify;font-family: none;">Finally, the following dictionary was used to map state names to two letter acronyms:</p>
```
