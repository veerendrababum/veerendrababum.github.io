...
<p style="text-align: justify;font-family: none;">The</p> [next step](/datapreparation/), <p style="text-align: justify;font-family: none;">which includes cleaning and processing of the data, is described here.</p>
